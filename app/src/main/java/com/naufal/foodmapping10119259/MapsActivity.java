...
import com.naufal.foodmapping10119259.databinding.ActivityMapsBinding;
...
//        res = findViewById(R.id.makanan);
        ress = findViewById(R.id.btn_makanan);
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                ...
                if (location != null){
                    ...
                    mMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)).position(latLng).title("Lokasi saat ini"));
